...
const resources = {
  ...
  ru: {
    translation: {
      ...
      image_selection_subtitle:
        'Выберите фоновые изображения для {{count}} слайда{{plural}}',
      ...
      image_selection_error:
        'Пожалуйста, выберите {{count}} изображений для ваших слайдов',
      ...
      app_icon_dev_message:
        'Настройки иконки сохранены. Изменения будут применены на реальном устройстве.',
      app_icon_success: 'Иконка приложения успешно изменена!',
      app_icon_error:
        'Не удалось изменить иконку приложения. Попробуйте еще раз.',
  ...
  de: {
    translation: {
      ...
      home_start_typing:
        'Beginnen Sie mit der Eingabe, um die Zeichenanzahl zu sehen',
      home_error_empty: 'Bitte geben Sie Text ein, um Folien zu generieren',

      // Image Selection Screen
      image_selection_title: 'Bilder auswählen',
      image_selection_subtitle:
        'Wählen Sie Hintergrundbilder für {{count}} Folie{{plural}}',
      ...
      image_selection_error:
        'Bitte wählen Sie {{count}} Bilder für Ihre Folien aus',
      image_selection_error_title: 'Fehler',
      image_selection_error_select_failed:
        'Bildauswahl fehlgeschlagen. Bitte versuchen Sie es erneut.',
      ...
      app_icon_dev_message:
        'App-Symbol-Einstellung gespeichert. Änderungen werden auf dem physischen Gerät wirksam.',
      app_icon_success: 'App-Symbol erfolgreich geändert!',
      app_icon_error:
        'App-Symbol konnte nicht geändert werden. Bitte versuchen Sie es erneut.',
  ...
  fr: {
    translation: {
      ...
      splash_subtitle:
        'Création de belles diapositives à partir de votre texte',

      // Home Screen
      home_title: 'Créer des diapositives',
      home_subtitle:
        'Entrez votre texte ci-dessous pour générer des diapositives',
      ...
      home_error_empty:
        'Veuillez entrer du texte pour générer des diapositives',

      // Image Selection Screen
      image_selection_title: 'Sélectionner des images',
      image_selection_subtitle:
        'Choisissez des images de fond pour {{count}} diapositive{{plural}}',
      ...
      image_selection_error:
        'Veuillez sélectionner {{count}} images pour vos diapositives',
      image_selection_error_title: 'Erreur',
      image_selection_error_select_failed:
        "Échec de la sélection d'image. Veuillez réessayer.",
      ...
      app_icon_dev_message:
        "Préférence d'icône sauvegardée. Les changements prendront effet sur l'appareil physique.",
  ...
  pt: {
    translation: {
      ...
      image_selection_subtitle:
        'Escolha imagens de fundo para {{count}} slide{{plural}}',
      ...
      image_selection_error:
        'Por favor, selecione {{count}} imagens para seus slides',
      ...
      app_icon_dev_message:
        'Preferência de ícone salva. As mudanças terão efeito no dispositivo físico.',
  ...
  ja: {
    translation: {
      ...
      app_icon_dev_message:
        'アプリアイコンの設定が保存されました。物理デバイスで変更が反映されます。',
      app_icon_success: 'アプリアイコンが正常に変更されました！',
      app_icon_error:
        'アプリアイコンの変更に失敗しました。再試行してください。',
  ...
  ko: {
    translation: {
      ...
      image_selection_subtitle:
        '{{count}}개의 슬라이드{{plural}}에 대한 배경 이미지를 선택하세요',
      ...
      app_icon_dev_message:
        '앱 아이콘 설정이 저장되었습니다. 실제 기기에서 변경 사항이 적용됩니다.',
  ...
  uk: {
    translation: {
      ...
      image_selection_subtitle:
        'Виберіть фонові зображення для {{count}} слайда{{plural}}',
      image_selection_slide: 'Слайд {{number}}',
      ...
      image_selection_error:
        'Будь ласка, виберіть {{count}} зображень для ваших слайдів',
      ...
      app_icon_dev_message:
        'Налаштування іконки збережено. Зміни набудуть чинності на фізичному пристрої.',
  ...
  es: {
    translation: {
      ...
      image_selection_subtitle:
        'Elige imágenes de fondo para {{count}} diapositiva{{plural}}',
      ...
      image_selection_error:
        'Por favor selecciona {{count}} imágenes para tus diapositivas',
      ...
      app_icon_dev_message:
        'Preferencia de icono guardada. Los cambios tendrán efecto en el dispositivo físico.',
      app_icon_success: '¡Icono de app cambiado exitosamente!',
      app_icon_error:
        'Error al cambiar el icono de la app. Inténtalo de nuevo.',
